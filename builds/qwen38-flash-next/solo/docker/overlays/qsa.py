...
class Qwen3_8FlashNextQSAFlashAttentionImpl(FlashAttentionImpl):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if self.kv_cache_dtype not in _QSA_KV_CACHE_DTYPES:
            raise NotImplementedError(
                "Qwen3.8-Flash-Next QSA requires a BF16, FP8-E4M3 or NVFP4 main KV cache"
            )
    ...
    def do_kv_cache_update(
        ...
        except ImportError:  # MBX: this build keeps the op in _custom_ops (fa_utils has no wrapper yet)
    ...
    def __init__(
        ...
        *,
        ...
        if self.kv_cache_torch_dtype not in _QSA_KV_STORAGE_DTYPES:
            raise NotImplementedError(
                "Qwen3.8-Flash-Next QSA requires BF16, FP8-E4M3 or NVFP4 cache storage"
            )
