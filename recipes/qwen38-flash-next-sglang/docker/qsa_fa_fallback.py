# From MiaAI-Lab/Qwen3.8-Flash-Next-Dual-DGX-Sparks (MIT, (c) 2026 Mia's AI Lab) — extracted verbatim
# from their start.sh write_patch_context(). See .data/miaai/ for the source repo and README.
